...
const Banner = () => {
    return (
        <div>
            <div className="hero lg:min-h-screen h-[350px]" style={{ backgroundImage: `url("https://images.pexels.com/photos/89778/strawberries-frisch-ripe-sweet-89778.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")` }}>
